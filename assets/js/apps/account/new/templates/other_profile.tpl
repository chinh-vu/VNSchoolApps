   <form class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="controls">
                    <select class="form-control" id="contactMthd" name="contactMthd">
        ...
        <div class="form-group">
            <div class="col-md-3">
                <div class="controls">
                    <input type="text" id="donation" name="donation" placeholder="Donation"
                           class="form-control">
                </div>
            </div>
         </div>
         <div class="form-group">
          ...
          <hr>
           <div class="form-group">
               <div class="col-md-3">
                   <div class="controls">
                       <input type="text" id="testScore" name="testScore" placeholder="Test Score"
                              class="form-control">
                   </div>
               </div>
            </div>
         <div class="form-group">
            <div class="col-md-3">
                <div class="controls">
                    <select class="form-control" id="suggestedClass" name="suggestedClass">
                        <option value="KG">Kinder Gartern</option>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <button type="button" class="btn btn-primary js-save-other">&nbsp;&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;&nbsp;</button>
